...
# -*- coding: utf-8 -*-
#
# wdfkit documentation build configuration file, created by  # noqa: E501
...
project = "wdfkit"
copyright = "%Y, SVI - Saint Gobain Innovation Hub Europe"
...
# Logo at the top of the sphinx_rtd_theme sidebar (blue header area).
html_logo = "img/logo-no-background.png"
...
basename = "wdfkit".replace(" ", "").replace(".", "")
...
# Intersphinx: resolve cross-references to external package docs.
intersphinx_mapping = {
